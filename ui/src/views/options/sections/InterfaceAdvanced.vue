        ...
        <div class="column">
          <section>
            <b-field :label="$t('SLR Scraper')" label-position="on-border">
              <b-input v-model="slrAuthCookie" :placeholder="$t('Enter the value for the auth_jwt cookie')" type="password"></b-input>
            </b-field>
            <b-field>
              <b-button type="is-primary" @click="save">Save</b-button>
            </b-field>
    ...
    validateScraperFields() {      
      ...
      if (this.scraperName != "") {
        if (this.scraperUrl.startsWith("https://") || this.scraperUrl.startsWith("http://") ) {
          if (this.scraperUrl.includes("povr.com") || this.scraperUrl.includes("sexlikereal.com") || this.scraperUrl.includes("vrphub.com") || this.scraperUrl.includes("vrporn.com") || this.scraperUrl.includes("realvr.com")) {
